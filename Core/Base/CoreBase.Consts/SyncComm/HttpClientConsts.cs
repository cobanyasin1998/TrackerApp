namespace CoreBase.Consts.SyncComm;
...
public class HttpClientConsts
{
    ...
    //// Timeout süreleri
    //public const int DefaultRequestTimeoutSeconds = 30;      // Varsayılan istek zaman aşımı süresi (30 saniye)
    //public const int LongRequestTimeoutSeconds = 60;         // Uzun süreli istekler için zaman aşımı süresi (60 saniye)
